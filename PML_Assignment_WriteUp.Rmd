...
Discuss PCA and 4 models chosen here
...
Model 1 discussion, accuracy, cross validation, out of sample error, etc...
...
Same as above, but this time for model 2.
...
And conclusions, including results of predictions. (i.e. question 3 and 6 were wrong for all models)




Appendix here if needed - This may be to discuss PAM - unsurpevised algorithm with 5 clusters and why it failed
